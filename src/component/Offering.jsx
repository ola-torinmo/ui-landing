 ...
 const Offering = () => {
  return (
    <div className='w-full bg-white'>
       <h1 className="text-[#009387] text-center text-3xl pt-[150px]">Our other service offerings</h1>
      
      <div className='md:max-w-[1028px] max-w-[600px] flex flex-col md:flex-row  m-auto pt-[100px]'>
      ...
      <div>
      <div className='md:max-w-[1028px] max-w-[600px] flex flex-col md:flex-row  m-auto py-[100px]'>
                <div className="flex md:mr-12">
                    <span className="pr-3 sticky top-0 shrink-0 md:pl-0 pl-5   "><img src={star}/></span>
